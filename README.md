...
Home: https://pypi.org/project/robotframework
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/robotframework-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/robotframework-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add _robotframework_tests robotframework
# for installing globally
pixi global install _robotframework_tests robotframework
```
...
It is possible to list all of the versions of `_robotframework_tests` available on your platform:
...
```
pixi search _robotframework_tests --channel conda-forge
```
